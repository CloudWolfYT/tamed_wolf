...
data modify entity @e[tag=new,tag=tamed_wolf,limit=1] OwnerUUID set from entity @e[type=item,nbt={Item:{id:"minecraft:player_head"}},sort=nearest,limit=1] Item.tag.SkullOwner.Id
